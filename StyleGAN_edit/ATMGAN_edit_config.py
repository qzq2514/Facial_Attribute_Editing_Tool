...
curly_hair["resolution"] = 8
curly_hair["fmap"] = np.array([26,92])
curly_hair["range"] = [-30,35]   #[-15,20]
curly_hair["location"] = np.array([2,3,4,5,        #从0开始
                                   9,10,11,12,13,14,
                                   17,18,21,22,
                                   25,30, 25,30,31,
                                    32,33,38,39,
